    ...
    render() {
        ...
        if (this.store.status === 1) {
            if (store.presentations.length > 0) {
                ...
                display = <div>
                    <div style={boxStyle}>
                        <Grid container spacing={3} className = "grid-css">
                            <Grid item xs={12}>
                                <h2 >
                                    <Tv style={iconStyles.largeIcon} /> 
                                    DHIS2 Smart Display<br/>
                                </h2> <p>The ultimate DHIS2 digital experience on smart screens</p><br />
                                <h3></h3>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <p>
                                    <h1> Welcome</h1><br/>
                                    The DHIS2 smart display application gives you an ultimate digital experience to present your 
                                    DHIS2 dashboard. No more hustle downloading analysis objects to create powerpoint presentations.
                                    The smart display application gives you the fastest way to present your dataurlnewwindow
                                    to your audience.
                                </p>
                            </Grid>
                            <Grid item xs={12} sm={6}>
